<footer class="footer">
    <div class="footer__grid">
        ...
        <nav class="menu-redes"> 
            ...
            <a class="menu-redes__enlace" rel="noopener noreferrer" target="_blank" href="https://t.me/Leeo23">
                <span class="menu-redes__ocultar">Telegram</span>
            </a>

            <a class="menu-redes__enlace" rel="noopener noreferrer" target="_blank" href="https://github.com/Lean-98">
                <span class="menu-redes__ocultar">Github</span>
            </a>

            <a class="menu-redes__enlace" rel="noopener noreferrer" target="_blank" href="https://fernando-herrera.com/#/studentdetail/leanfrag23@gmail.com">
                <span class="menu-redes__ocultar">Academia fernando Herrera</span>
            </a>

            <a class="menu-redes__enlace" rel="noopener noreferrer" target="_blank" href="https://www.linkedin.com/in/leandro-piazza23/">
